...
\mlsystitlerunning{Submission and Formatting Instructions for MLSys 2020}

\begin{document}

\twocolumn[
\mlsystitle{Submission and Formatting Instructions for MLSys 2020}
...
Submission to MLSys 2020 will be entirely electronic, via a web site
(not email). Information about the submission process and \LaTeX\ templates
are available on the conference web site at:
\begin{center}
\textbf{\texttt{https://www.mlsys.cc/}}
\end{center}
...
\item The maximum paper length is \textbf{10 pages excluding references.}
...
\texttt{nohyperref} as one of the options to the \texttt{mlsys2020}
...
The footnote, ``Preliminary work. Under review by the MLSys. Do not distribute.'' must be
modified to ``\textit{Proceedings of the
$\mathit{3}^{rd}$ MLSys Conference},
Austin, TX, USA, 2020.
Copyright 2020 by the author(s).''

For those using the \textbf{\LaTeX} style file, this change (and others) is
handled automatically by simply changing
$\mathtt{\backslash usepackage\{mlsys2020\}}$ to
$$\mathtt{\backslash usepackage[accepted]\{mlsys2020\}}$$
...
you are using \LaTeX\/ and the \texttt{mlsys2020.sty} file, use
...
A sample file with author names is included in the mlsys2020 style file
...
facility, use \texttt{natbib.sty} and \texttt{mlsys2020.bst}
